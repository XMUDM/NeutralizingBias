...
class ContextManager(object):
    ...
    def set_trainer(flags_obj, cm,  dm):
        ...
        elif 'PID' in flags_obj.model:
            return trainer.PIDPairTrainer(flags_obj, cm,  dm)
        else:
    ...
    def set_recommender(flags_obj, workspace, dm):
        ...
        elif flags_obj.model == 'PIDMF':
            return recommender.PIDRecommender(flags_obj, workspace, dm)
