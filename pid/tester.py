...
class Tester(object):
    ...
    def filter_history(self, items, train_pos, test_pos):
        ...
        u_i_dict = {}
        pop_dict = {}
        p = '/data2/gpxu/popular_debias/pid/result/' + self.flags_obj.name + '2022/'
        ...
        b = np.load("/data2/gpxu/popular_debias/pid/data/" + self.flags_obj.dataset +"/popularity_train.npy", allow_pickle=True)
