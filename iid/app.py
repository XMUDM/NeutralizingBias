...
import sys
sys.path.append('/data2/gpxu/popular_debias/iid/')
import os
import utils

FLAGS = flags.FLAGS

flags.DEFINE_string('name', 'ml100k-IIDMF-debug', 'Experiment name.')
flags.DEFINE_enum('model', 'IIDMF', ['IIDMF', 'MF'], 'Model name.')
...
flags.DEFINE_string('output', '/data2/gpxu/popular_debias/iid/result/', 'Directory to save model/log/metrics.')
